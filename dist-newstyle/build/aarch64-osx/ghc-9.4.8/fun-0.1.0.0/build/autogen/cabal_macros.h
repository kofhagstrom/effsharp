...
/* package fun-0.1.0.0 */
#ifndef VERSION_fun
#define VERSION_fun "0.1.0.0"
#endif /* VERSION_fun */
#ifndef MIN_VERSION_fun
#define MIN_VERSION_fun(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_fun */
...
#define CURRENT_PACKAGE_KEY "fun-0.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "fun-0.1.0.0-inplace"
